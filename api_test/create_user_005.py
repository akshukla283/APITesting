...
# it was a small payload in realtime we will have
# big data as payload, or predefined json data
# let's create 'data_01.json' file
# As we know that through 'open' function we can load any data
